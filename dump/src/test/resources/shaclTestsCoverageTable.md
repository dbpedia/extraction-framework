...
[http://cs.dbpedia.org/resource/Český_(rozcestník)](http://dief.tools.dbpedia.org/server/extraction/cs/extract?title=Český_(rozcestník)&revid=&format=trix&extractors=custom) | http://cs.dbpedia.org/resource/Český_(rozcestník) #Český_(rozcestník)_cs | 
...
[http://en.dbpedia.org/resource/IKEA](http://dief.tools.dbpedia.org/server/extraction/en/extract?title=IKEA&revid=&format=trix&extractors=custom) | http://dbpedia.org/resource/IKEA #IKEA | https://github.com/dbpedia/extraction-framework/issues/630 | no  company type for some specific entities (e.g. IKEA; Samsung) | 
