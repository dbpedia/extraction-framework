...
# run this directly from $DBPPREFIX/extraction-framework/scripts
...
../run TypeStatistics /media/bigone/25TB/www/downloads.dbpedia.org/2015-10 .ttl.bz2 "mappingbased_literals,mappingbased_objects,geo_coordinates_mappingbased,instance_types,instance_types_transitive" stats-raw-infoboxes.json canonicalized listproperties donotlist
...
../run PostProcessinfStats /media/bigone/25TB/www/downloads.dbpedia.org/2015-10 stats-instances-cd.json stats-instances-ld.json stats-mappingbased.json stats-raw-infoboxes.json stats-type-statistics.json stats-general-stats.json stats-properties-stats.json stats-types-stats.json