...
../run TypeStatistics /media/bigone/25TB/www/downloads.dbpedia.org/2015-10 .ttl.bz2 "mappingbased_literals,mappingbased_objects,geo_coordinates_mappingbased" stats-mappingbased.json canonicalized listproperties donotlist
