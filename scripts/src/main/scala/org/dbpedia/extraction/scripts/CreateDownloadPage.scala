...
val datasets = List(
  List(
    ...
    new Dataset("Ontology Infobox Properties (Cleaned)", "mappingbased_properties_cleaned", "//Infobox data from the ontology-based extraction minus some triples that the heuristic described in ... indentified as incorrect.//", Set(DataC14NPage)),
