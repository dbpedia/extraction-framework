...
private class NamespaceBuilder {
  ...
  // wikidata added 1198,1199 in early 2013. Let's go up to 1999 to prepare for future additions.
  for (code <- (90 to 112 by 2) ++ (400 to 1998 by 2)) ns(code, "Namespace "+code, false)
