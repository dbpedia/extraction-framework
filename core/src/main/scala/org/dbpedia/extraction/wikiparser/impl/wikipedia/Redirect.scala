...
object Redirect
{
    ...
    private def sa_redirects = Set("#पुनर्निदेशन","#अनुप्रेषित","#REDIRECT","#पुनर्प्रेषित")
