...
object Redirect
{
    ...
    private def br_redirects = Set("#ADKAS","#REDIRECT","#REDIRECTION")
    ...
    private def dty_redirects = Set("#REDIRECT")
    ...
    private def hyw_redirects = Set("#ՎԵՐԱՀՂՈՒՄ","#ՎԵՐԱՅՂՈՒՄ","0","#REDIRECT")
    ...
    private def inh_redirects = Set("#перенаправление","#перенапр","#REDIRECT")
    ...
    private def lez_redirects = Set("#перенаправление","#перенапр","#REDIRECT","#İSTİQAMƏTLƏNDİRMƏ","#İSTİQAMƏTLƏNDİR")
