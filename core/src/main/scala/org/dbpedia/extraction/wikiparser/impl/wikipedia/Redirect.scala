...
object Redirect
{
    ...
    private def diq_redirects = Set("#REDIRECT")
    ...
    private def fa_redirects = Set("#تغییرمسیر","#REDIRECT")
    ...
    private def glk_redirects = Set("#تغییرمسیر","#REDIRECT")
    ...
    private def ku_redirects = Set("#REDIRECT")
    ...
    private def mzn_redirects = Set("#بور","#تغییرمسیر","#REDIRECT")
    ...
    private def se_redirects = Set("#REDIRECT")
