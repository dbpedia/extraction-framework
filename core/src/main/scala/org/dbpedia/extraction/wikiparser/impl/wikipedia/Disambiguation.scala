...
object Disambiguation
{
    ...
    private def avk_disambiguations = Set("Milyoltaca")
    ...
    private def be_disambiguations = Set("Спіс цёзак2","Шматзначнасць","Неадназначнасць","Disambiguation","Спіс поўных цёзак","Disambig","Спіс цёзак")
    ...
    private def bn_disambiguations = Set("দ্ব্যর্থতা_নিরসন")
    ...
    private def ce_disambiguations = Set("Цхьа цӀе йолу урамаш","Disambiguation","Цхьа цӀе йолу меттигаш","Цхьа цӀе йолу аьчка некъа агӀонаш","Moviedis","Disambig","Цхьа цӀе йолу шагойтарш","Surname","Placedis","Metrodis","Roaddis","Неоднозначность","Дуккха маьӀанца","Цхьатера маьӀна доцуш","Доьзал цӀе")
    ...
    private def fa_disambiguations = Set("ابهام‌زدایی نام","ابهام‌زدایی ریاضی","ابهام‌زدایی-جغرافیا","رفع ابهام","ابهام‌زدایی اعداد","ابهام‌زدایی فرودگاه","ابهام‌زدایی نهاد آموزشی","ابهام‌زدایی","ابهام زدایی","ابهام‌زدایی جغرافیا","ابهام‌زدائی")
    ...
    private def fr_disambiguations = Set("Patronyme danois","Homonymie de cyclones","Unités homonymes","Cathédrales homonymes","Homonymie d'îles","Patronyme finnois","Internationalisation","Patronyme suédois","Patronyme macédonien","Homonymie d'établissements scolaires ou universitaires","Cantons homonymes","Homonymie bateau","Homonymie de comtés","Homonymie de patronyme","Églises homonymes","Rues homonymes","Toponymie","Couvents homonymes","Monastères homonymes","Patronyme azéri","Homonymie numismatique","Saints homonymes","Abbayes homonymes","Prieurés homonymes","Surnoms homonymes","Patronyme bulgare","Calvaires homonymes","Patronymie","Homonymie Comète","Place ou square homonyme","Patronyme germanique","Patronyme indien","Surname","Homonymie Sega","Arrondissements homonymes","Patronyme croate","Patronyme basque","Patronyme norvégien","Patronyme italien","Homonymie vidéoludique","Patronyme islandais","Personnes homonymes","Patronyme","Homonymie édifice religieux","Patronyme bosniaque","Patronyme serbe","Patronyme turc","Communes françaises homonymes","Patronyme slovène","Patronymes","Pseudonymes homonymes","Homonymie homophonie","Batailles homonymes","Chartreuses homonymes","Paronymie","Homonymie de route","Patronyme albanais","Hydronymie","Patronyme hongrois","Prénoms homonymes","Gouvernements homonymes","Homonymie de monument","Basiliques homonymes","Isomérie","Homonymie de nom romain","Homonymie de ponts","Patronyme finlandais","Titres homonymes","Homonymie mathématique","Guerres homonymes","Homonymie de titre","Bandeau standard pour page d'homonymie","Disambiguation","Homonymie de clubs sportifs","Abbatiales homonymes","Homonymie","Villes homonymes","Collégiales homonymes","Films homonymes","Patronyme maltais","Homonymie de comète","Homonymie comète","Homonymie dynastique","Homonymie de parti politique","Chapelles homonymes","Édifices religieux homonymes")
    ...
    private def hy_disambiguations = Set("Երկիմաստ")
    private def ia_disambiguations = Set("Disambiguation")
    private def id_disambiguations = Set("Disambig karya","Disambig-cleanup","Disambig nama","Disambig tempat Prancis","Disingkat","Disambig tempat Indonesia","Disambig gereja","Disambig sekolah","Disambig","Disambig kapal","Disambig suku","Hndis","Disambig nama Indonesia","Disambig sejarah","Disambig angka","Disambig bandara","Disambig tempat","Disambig nama Tionghoa","Disambig tempat indo","Disambig indo1","Disambig nama Korea Selatan","Disambig tempat Amerika Serikat","Disambig olahraga","Disambiguasi")
    ...
    private def inh_disambiguations = Set("Неоднозначность")
    ...
    private def lld_disambiguations = Set("Disambigua")
    ...
    private def mwl_disambiguations = Set("Disambig","Zambiguaçon")
    ...
    private def ne_disambiguations = Set("अस्पष्टता")
    ...
    private def pl_disambiguations = Set("Ujednoznacznienie","Disambig","Strona ujednoznaczniająca")
    ...
    private def ru_disambiguations = Set("Disambiguation","Воинские части","Список полных тёзок","Disambig","Военные части","Список однофамильцев-тёзок","Список однофамильцев","Список тёзок","Список тёзок-однофамильцев","Одноимённые воинские части","Воинские формирования","Militarydis","Неоднозначность","Многозначность")
    ...
    private def shi_disambiguations = Set("توضيح")
    ...
    private def sl_disambiguations = Set("Numberdis","Razločitev","Kazalo ladij","Disambig","Disambig-ship","Priimek","Razločitev osebnih imen","Disambig-divizija","Disambig-brigada","Disambig-polk","Disambig-korpus","Disambig-armada","Razločitev cest","Kratice","Geodis","Razločitev-kraj","Disambig-unit","Georaz")
    ...
    private def tcy_disambiguations = Set("ದ್ವಂದ್ವ ನಿವಾರಣೆ")
    ...
    private def zh_disambiguations = Set("消含糊","消除歧义","消歧义","消除歧義","Disambig","消歧義","消除含糊")
