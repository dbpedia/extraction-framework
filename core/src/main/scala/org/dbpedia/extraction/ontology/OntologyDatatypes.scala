...
object OntologyDatatypes
{
  def load() : List[Datatype] =
  {
    ...
    builder.addUnit(new FactorUnitDatatype("electronVolt", Set("eV","electron-volt", "electronvolt"), 1.6021766208E-19))
    builder.addUnit(new FactorUnitDatatype("milliElectronVolt", Set("meV","milli-electron-volt", "millielectronvolt"), 1.6021766208E-22))
    builder.addUnit(new FactorUnitDatatype("kiloElectronVolt", Set("keV","kilo-electron-volt", "kiloelectronvolt"), 1.6021766208E-16))
    builder.addUnit(new FactorUnitDatatype("megaElectronVolt", Set("MeV","mega-electron-volt", "megaelectronvolt"), 1.6021766208E-13))
    builder.addUnit(new FactorUnitDatatype("gigaElectronVolt", Set("GeV","giga-electron-volt", "gigaelectronvolt"), 1.6021766208E-10))
    builder.addUnit(new FactorUnitDatatype("teraElectronVolt", Set("TeV","tera-electron-volt", "teraelectronvolt"), 1.6021766208E-7))
    builder.addUnit(new FactorUnitDatatype("petaElectronVolt", Set("PeV","peta-electron-volt", "petaelectronvolt"), 1.6021766208E-4))
    builder.addUnit(new FactorUnitDatatype("exaElectronVolt", Set("EeV","exa-electron-volt", "exaelectronvolt"), 0.16021766208))
    types :::= builder.build
    ...
    builder.addUnit(new FactorUnitDatatype("atomicMassUnit", Set("Da","u","atomic mass unit", "Dalton"), 1.6605389E-24))
    types :::= builder.build
    ...
    builder.addUnit(new FactorUnitDatatype("inhabitantsPerHectare", Set("PD/ha","/ha","per hectare","inhabitants per hectare"), 100))
    ...
    builder.addUnit(new FactorUnitDatatype("inhabitantsPerAcre", Set("PD/acre","/acre","per acre","inhabitants per acre"), 247.105))
    types :::= builder.build
    ...
    builder.addDimension("MolarMass")
    builder.addUnit(new StandardUnitDatatype("gramPerMole", Set("g/mol")))
    builder.addUnit(new FactorUnitDatatype("kilogramPerMole", Set("kg/mol"), 0.001))
    types :::= builder.build
  ...
  {
    private var currentDimension : String = _
    ...
    def build: List[Datatype] = new DimensionDatatype(currentDimension, currentUnits.reverse) :: currentUnits
  }
}
