...
class Finder[T <% FileLike[T]](baseDir: T, language: Language, wikiNameGiven : String) {
  
  def this(baseDir: T, language: String, wikiNameGiven : String) = this(baseDir, Language(language), wikiNameGiven)
