...
object DateTimeParserConfig {
  ...
  val templateDateMap = Map(
    ...
    "en" -> Map(
      "birth date and age" -> Map(
        "year" -> "1",
        "month" -> "2",
        "day" -> "3"
      ), // "Birth date and age"
      "birth date and age2" -> Map(
        "year" -> "1",
        "month" -> "2",
        "day" -> "3"
      ), // "Birth date and age2"
      "start date and age" -> Map(
        "year" -> "1",
        "month" -> "2",
        "day" -> "3"
      ), // "Birth date and age2"
      "death date and age" -> Map(
        "year" -> "1",
        "month" -> "2",
        "day" -> "3"
      ), // "Death date and age"
      "end date and age" -> Map(
        "year" -> "1",
        "month" -> "2",
        "day" -> "3"
      ), // "Death date and age"
      ...
      "birthdeathage" -> Map(
        "ifPropertyNum" -> "1",
        "ifPropertyNumHasValue" -> "B", // "BirthDeathAge"
        "year" -> "2",
        "month" -> "3",
        "day" -> "4",
        "elseYear" -> "4",
    ...
    // Don't change this unless you know how it is done.
    "ar" -> Map(
      "تاريخ الازدياد و العمر" -> Map(
        "year" -> "1",
        "month" -> "2",
        "day" -> "3"
      ), // "Birth date and age"
      "تاريخ الوفاة و العمر" -> Map(
        "year" -> "1",
        "month" -> "2",
        "day" -> "3"
      ), // "Death date and age"
    ...
    "bg" -> Map(
      "Дата на раждане и години" -> Map(
        "year" -> "1",
        "month" -> "2",
        "day" -> "3"
      ),
      "Дата на раждане" -> Map("year" -> "1", "month" -> "2", "day" -> "3"),
      "Дата на смърт и години" -> Map(
        "year" -> "1",
        "month" -> "2",
        "day" -> "3"
      ),
    ...
    "ca" -> Map(
      ...
      "Data naixement i edat" -> Map(
        "year" -> "3",
        "month" -> "2",
        "day" -> "1"
      ),
      "Data naixement" -> Map("year" -> "3", "month" -> "2", "day" -> "1"),
      "Data defunció i edat" -> Map(
        "year" -> "3",
        "month" -> "2",
        "day" -> "1"
      ),
    ...
    "el" -> Map(
      "ημερομηνία γέννησης και ηλικία" -> Map(
        "year" -> "1",
        "month" -> "2",
        "day" -> "3"
      ),
      "ημερομηνία θανάτου και ηλικία" -> Map(
        "year" -> "1",
        "month" -> "2",
        "day" -> "3"
      ),
      "Ημερομηνία εκκίνησης και ηλικία" -> Map(
        "year" -> "1",
        "month" -> "2",
        "day" -> "3"
      ),
    ...
    "fr" -> Map(
      ...
      // conditional mapping
      "naissance décès âge" -> Map(
        "ifPropertyNum" -> "1",
        "ifPropertyNumHasValue" -> "N",
        "year" -> "4",
        "month" -> "3",
        "day" -> "2",
        "elseYear" -> "7",
    ...
    "ga" -> Map(
      "dáta breithe agus aois" -> Map(
        "bliain" -> "1",
        "mí" -> "2",
        "lá" -> "3"
      ), // "Lá breithe agus aois"
      "dáta breithe" -> Map(
        "bliain" -> "1",
        "mí" -> "2",
        "lá" -> "3"
    ...
    "id" -> Map(
      "Mula tanggal dan usia" -> Map(
        "year" -> "1",
        "month" -> "2",
        "day" -> "3"
      ),
      "Tanggal lahir dan umur" -> Map(
        "year" -> "1",
        "month" -> "2",
        "day" -> "3"
      ),
      "Tanggal kematian dan umur" -> Map(
        "year" -> "1",
        "month" -> "2",
        "day" -> "3"
      ),
      ...
      "Tanggal lahir dan umur2/doc" -> Map(
        "year" -> "1",
        "month" -> "2",
        "day" -> "3"
      ),
      "Tanggal lahir dan umur2" -> Map(
        "year" -> "1",
        "month" -> "2",
        "day" -> "3"
      ),
    ...
    "sl" -> Map(
      ...
      "Datum rojstva in starost" -> Map(
        "year" -> "1",
        "month" -> "2",
        "day" -> "3"
      ),
      "Datum rojstva in starost2" -> Map(
        "year" -> "1",
        "month" -> "2",
        "day" -> "3"
      ),
      "Datum smrti" -> Map("year" -> "1", "month" -> "2", "day" -> "3"),
      "Datum smrti in starost" -> Map(
        "year" -> "1",
        "month" -> "2",
        "day" -> "3"
      ),
      "Starost na datum" -> Map("year" -> "1", "month" -> "2", "day" -> "3"),
      "Starost v letih in dnevih" -> Map(
        "year" -> "1",
        "month" -> "2",
        "day" -> "3"
      ),
