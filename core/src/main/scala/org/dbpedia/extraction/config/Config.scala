...
class Config(properties: Properties) extends Properties(Config.combineProperties(Config.universalProperties, properties))
{
  ...
  def getDefaultExtractionRecorder[T](lang: Language, interval: Int = 100000, preamble: String = null, writer: Writer = null, datasets : List[Dataset] = List()): ExtractionRecorder[T] ={
    ...
    new ExtractionRecorder[T](w, interval, preamble, slackCredentials.getOrElse(null), datasets, lang, new ExtractionMonitor(this), provenanceRecordManager)
  }
  ...
  /**
    * manages all provenance records generated by extractors or transformers, creates new provenance datasets in the provided directory
    */
  lazy val provenanceRecordManager: ProvenanceRecordManager = getValue(this, "provenance-record-dir")(p => new ProvenanceRecordManager(new File(p)))
