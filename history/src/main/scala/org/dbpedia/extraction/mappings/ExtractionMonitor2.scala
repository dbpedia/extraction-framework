...
class ExtractionMonitor2 {
  private val stats : mutable.HashMap[ExtractionRecorder2[_], mutable.HashMap[String, Int]] = mutable.HashMap()
  private val errors : mutable.HashMap[ExtractionRecorder2[_], ListBuffer[Throwable]] = mutable.HashMap()
  ...
  private val ignorableExceptions : mutable.HashMap[ExtractionRecorder2[_], List[String]] = mutable.HashMap()
  ...
  /**
   * Initializes the Extraction Monitor for a specific ExtractionRecorder2
   * @param er ExtractionRecorder2
   */
  def init(er : ExtractionRecorder2[_]): Unit ={
  ...
  def init(er_list: List[ExtractionRecorder2[_]]): Unit ={
    er_list.foreach(init)
  }

  /**
   * Marks the ExtractionRecorder2 as crashed
   * @param er ExtractionRecorder2
   * @param ex Exception
   */
  def reportCrash(er : ExtractionRecorder2[_], ex : Throwable): Unit ={
   ...
   * @param ex Exception
   */
  def reportError(er : ExtractionRecorder2[_], ex : Throwable): Unit = {
    var ignorable = false
  ...
  /**
   * Summary of data for the ExtractionRecorder2
   * @param er ExtractionRecorder2
   * @param datasets List of Datasets that will be compared by DatasetID
   * @return Summary-Report
   */
  def summarize(er : ExtractionRecorder2[_], datasets : ListBuffer[Dataset] = ListBuffer()): mutable.HashMap[String, Object] ={
   ...
   */
  def compareTripleCount(dataIDUrl : String, extractionRecorder2: ExtractionRecorder2[_], datasets : ListBuffer[Dataset]): Option[String] ={
    try {
      var resultString = ""
      // Load Graph
        ...
        if (datasets.nonEmpty) {
          datasets.foreach(dataset =>
            if (dataset.canonicalUri == fileName) {
              ...
              val newValue: Long = extractionRecorder2.successfulTriples(dataset)
              val change: Float =
