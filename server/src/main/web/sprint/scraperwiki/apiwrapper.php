...
<head>
  ...
  <meta name="keywords" content="ScraperWiki,Code,repository,for,ScraperWiki.com,source,sourcecode,scraperlibs/scraperwiki/apiwrapper.php@c0f684545717" />
  <!--[if lt IE 9]>
	...
	<table class="info-table">
		<tr>
			...
			<th class="source-view-links">
				<a id="embed-link" href="#" onclick="makeEmbed('#embed-link', 'https://bitbucket.org/ScraperWiki/scraperwiki/src/c0f684545717/scraperlibs/scraperwiki/apiwrapper.php?embed=t');">embed</a> /
				<a href="/ScraperWiki/scraperwiki/history/scraperlibs/scraperwiki/apiwrapper.php">history</a> /
				<a href="/ScraperWiki/scraperwiki/annotate/c0f684545717/scraperlibs/scraperwiki/apiwrapper.php">annotate</a> /
				<a href="/ScraperWiki/scraperwiki/raw/c0f684545717/scraperlibs/scraperwiki/apiwrapper.php">raw</a> /
				<form action="/ScraperWiki/scraperwiki/diff/scraperlibs/scraperwiki/apiwrapper.php" class="source-view-form">
					
					<input type="hidden" name="diff2" value="c0f684545717" />
						<select name="diff1" class="smaller">
							
								
									<option value="a4bccd508dd0">
										r3105:a4bccd508dd0
									</option>
								
							
								
									<option value="75411fc4c159">
										r3101:75411fc4c159
									</option>
								
							
								
									<option value="d5e1ccad9f49">
										r3100:d5e1ccad9f49
									</option>
								
							
								
									<option value="65d24e238910">
										r3098:65d24e238910
									</option>
								
							
								
									<option value="dbbaddc2d849">
										r3097:dbbaddc2d849
									</option>
								
							
								
									<option value="906f6b640b39">
										r3095:906f6b640b39
									</option>
								
							
								
									<option value="daacb53f32e8">
										r2126:daacb53f32e8
									</option>
								
							
								
									<option value="4da181b6cd10">
										r1938:4da181b6cd10
									</option>
								
							
								
									<option value="852e2c963489">
										r1926:852e2c963489
									</option>
								
							
								
									<option value="57ad3133e217">
										r1851:57ad3133e217
									</option>
								
							
								
									<option value="a6f3ff8eba30">
										r1848:a6f3ff8eba30
									</option>
...
<a name="cl-2"></a><span class="c1">// code ported from http://scraperwiki.com/views/php-api-access/</span>
<a name="cl-3"></a><span class="nv">$apiurl</span> <span class="o">=</span> <span class="s2">&quot;http://api.scraperwiki.com/api/1.0/datastore/&quot;</span><span class="p">;</span> 
<a name="cl-4"></a><span class="nv">$attacheddata</span> <span class="o">=</span> <span class="k">array</span><span class="p">();</span> 
<a name="cl-5"></a><span class="k">class</span> <span class="nc">SW_APIWrapperClass</span>
<a name="cl-6"></a><span class="p">{</span>
<a name="cl-7"></a>    <span class="k">static</span> <span class="k">function</span> <span class="nf">getKeys</span><span class="p">(</span><span class="nv">$name</span><span class="p">)</span>
<a name="cl-8"></a>    <span class="p">{</span>
<a name="cl-9"></a>        <span class="k">global</span> <span class="nv">$attacheddata</span><span class="p">;</span> 
<a name="cl-10"></a>        <span class="k">if</span> <span class="p">(</span><span class="o">!</span><span class="nb">in_array</span><span class="p">(</span><span class="nv">$name</span><span class="p">,</span> <span class="nv">$attacheddata</span><span class="p">))</span>
<a name="cl-11"></a>        <span class="p">{</span>
<a name="cl-12"></a>            <span class="k">print</span> <span class="s2">&quot;*** instead of getKeys(&#39;</span><span class="si">$name</span><span class="s2">&#39;) please do</span><span class="se">\n</span><span class="s2">    scraperwiki.sqlite.attach(&#39;</span><span class="si">$name</span><span class="s2">&#39;) </span><span class="se">\n</span><span class="s2">    print scraperwiki.sqlite.execute(&#39;select * from `</span><span class="si">$name</span><span class="s2">`.swdata limit 0&#39;)-&gt;keys&quot;</span><span class="p">;</span> 
<a name="cl-13"></a>            <span class="nx">scraperwiki</span><span class="o">::</span><span class="na">attach</span><span class="p">(</span><span class="nv">$name</span><span class="p">);</span>
<a name="cl-14"></a>            <span class="nb">array_push</span><span class="p">(</span><span class="nv">$attacheddata</span><span class="p">,</span> <span class="nv">$name</span><span class="p">);</span> 
<a name="cl-15"></a>        <span class="p">}</span>
<a name="cl-16"></a>        <span class="nv">$result</span> <span class="o">=</span> <span class="nx">scraperwiki</span><span class="o">::</span><span class="na">sqlitecommand</span><span class="p">(</span><span class="s2">&quot;execute&quot;</span><span class="p">,</span> <span class="s2">&quot;select * from `</span><span class="si">$name</span><span class="s2">`.swdata limit 0&quot;</span><span class="p">);</span> 
<a name="cl-17"></a>        <span class="k">return</span> <span class="nv">$result</span><span class="o">-&gt;</span><span class="na">keys</span><span class="p">;</span> 
<a name="cl-18"></a>    <span class="p">}</span>
<a name="cl-19"></a>
<a name="cl-20"></a>    <span class="k">static</span> <span class="k">function</span> <span class="nf">getInfo</span><span class="p">(</span><span class="nv">$name</span><span class="p">)</span>
<a name="cl-21"></a>    <span class="p">{</span>
<a name="cl-22"></a>        <span class="nv">$url</span> <span class="o">=</span> <span class="s2">&quot;http://api.scraperwiki.com/api/1.0/scraper/getinfo?name=&quot;</span><span class="o">.</span><span class="nb">urlencode</span><span class="p">(</span><span class="nv">$name</span><span class="p">);</span> 
<a name="cl-23"></a>        <span class="nv">$handle</span> <span class="o">=</span> <span class="nb">fopen</span><span class="p">(</span><span class="nv">$url</span><span class="p">,</span> <span class="s2">&quot;r&quot;</span><span class="p">);</span> 
<a name="cl-24"></a>        <span class="nv">$ljson</span> <span class="o">=</span> <span class="nb">stream_get_contents</span><span class="p">(</span><span class="nv">$handle</span><span class="p">);</span> 
<a name="cl-25"></a>        <span class="nb">fclose</span><span class="p">(</span><span class="nv">$handle</span><span class="p">);</span>
<a name="cl-26"></a>        <span class="k">return</span> <span class="nx">json_decode</span><span class="p">(</span><span class="nv">$ljson</span><span class="p">);</span> 
<a name="cl-27"></a>    <span class="p">}</span>
<a name="cl-28"></a>
<a name="cl-29"></a>    <span class="k">static</span> <span class="k">function</span> <span class="nf">getData</span><span class="p">(</span><span class="nv">$name</span><span class="p">,</span> <span class="nv">$limit</span><span class="o">=</span> <span class="o">-</span><span class="m">1</span><span class="p">,</span> <span class="nv">$offset</span><span class="o">=</span> <span class="m">0</span><span class="p">)</span>
<a name="cl-30"></a>    <span class="p">{</span>
<a name="cl-31"></a>        <span class="k">global</span> <span class="nv">$attacheddata</span><span class="p">;</span> 
<a name="cl-32"></a>        <span class="k">if</span> <span class="p">(</span><span class="o">!</span><span class="nb">in_array</span><span class="p">(</span><span class="nv">$name</span><span class="p">,</span> <span class="nv">$attacheddata</span><span class="p">))</span>
<a name="cl-33"></a>        <span class="p">{</span>
<a name="cl-34"></a>            <span class="k">print</span> <span class="s2">&quot;*** instead of getData(&#39;</span><span class="si">$name</span><span class="s2">&#39;) please do</span><span class="se">\n</span><span class="s2">    scraperwiki.sqlite.attach(&#39;</span><span class="si">$name</span><span class="s2">&#39;) </span><span class="se">\n</span><span class="s2">    print scraperwiki.sqlite.select(&#39;* from `</span><span class="si">$name</span><span class="s2">`.swdata&#39;)&quot;</span><span class="p">;</span> 
<a name="cl-35"></a>            <span class="nx">scraperwiki</span><span class="o">::</span><span class="na">attach</span><span class="p">(</span><span class="nv">$name</span><span class="p">);</span>
<a name="cl-36"></a>            <span class="nb">array_push</span><span class="p">(</span><span class="nv">$attacheddata</span><span class="p">,</span> <span class="nv">$name</span><span class="p">);</span> 
<a name="cl-37"></a>        <span class="p">}</span>
<a name="cl-38"></a>        <span class="nv">$apilimit</span> <span class="o">=</span> <span class="m">100</span><span class="p">;</span> 
<a name="cl-39"></a>        <span class="nv">$count</span> <span class="o">=</span> <span class="m">0</span><span class="p">;</span>
<a name="cl-40"></a>        <span class="nv">$loffset</span> <span class="o">=</span> <span class="m">0</span><span class="p">;</span>
<a name="cl-41"></a>        <span class="nv">$result</span> <span class="o">=</span> <span class="k">array</span><span class="p">();</span> 
<a name="cl-42"></a>        <span class="k">while</span> <span class="p">(</span><span class="k">true</span><span class="p">)</span>
<a name="cl-43"></a>        <span class="p">{</span>
<a name="cl-44"></a>            <span class="nv">$llimit</span> <span class="o">=</span> <span class="p">(</span><span class="nv">$limit</span> <span class="o">==</span> <span class="o">-</span><span class="m">1</span> <span class="o">?</span> <span class="nv">$apilimit</span> <span class="o">:</span> <span class="nb">min</span><span class="p">(</span><span class="nv">$apilimit</span><span class="p">,</span> <span class="nv">$limit</span><span class="o">-</span><span class="nv">$count</span><span class="p">));</span> 
<a name="cl-45"></a>            <span class="nv">$query</span> <span class="o">=</span> <span class="s2">&quot;* from `</span><span class="si">$name</span><span class="s2">`.swdata limit </span><span class="si">$llimit</span><span class="s2"> offset &quot;</span><span class="o">.</span><span class="p">(</span><span class="nv">$offset</span><span class="o">+</span><span class="nv">$loffset</span><span class="p">);</span> 
<a name="cl-46"></a>            <span class="nv">$lresult</span> <span class="o">=</span> <span class="nx">scraperwiki</span><span class="o">::</span><span class="na">select</span><span class="p">(</span><span class="nv">$query</span><span class="p">);</span> 
<a name="cl-47"></a>            <span class="nv">$count</span> <span class="o">+=</span> <span class="nb">count</span><span class="p">(</span><span class="nv">$lresult</span><span class="p">);</span> 
<a name="cl-48"></a>            <span class="k">foreach</span> <span class="p">(</span><span class="nv">$lresult</span> <span class="k">as</span> <span class="nv">$k</span><span class="o">=&gt;</span><span class="nv">$v</span><span class="p">)</span>
<a name="cl-49"></a>                <span class="nb">array_push</span><span class="p">(</span><span class="nv">$result</span><span class="p">,</span> <span class="p">(</span><span class="nx">object</span><span class="p">)</span><span class="nv">$v</span><span class="p">);</span> 
<a name="cl-50"></a>            <span class="k">if</span> <span class="p">(</span><span class="nb">count</span><span class="p">(</span><span class="nv">$lresult</span><span class="p">)</span> <span class="o">&lt;</span> <span class="nv">$llimit</span><span class="p">)</span>
<a name="cl-51"></a>                <span class="k">break</span><span class="p">;</span> 
<a name="cl-52"></a>            <span class="k">if</span> <span class="p">((</span><span class="nv">$limit</span> <span class="o">!=</span> <span class="o">-</span><span class="m">1</span><span class="p">)</span> <span class="k">and</span> <span class="p">(</span><span class="nv">$count</span> <span class="o">&gt;=</span> <span class="nv">$limit</span><span class="p">))</span>
<a name="cl-53"></a>                <span class="k">break</span><span class="p">;</span> 
<a name="cl-54"></a>            <span class="nv">$loffset</span> <span class="o">+=</span> <span class="nv">$llimit</span><span class="p">;</span> 
<a name="cl-55"></a>        <span class="p">}</span>
<a name="cl-56"></a>        <span class="k">return</span> <span class="nv">$result</span><span class="p">;</span> 
<a name="cl-57"></a>    <span class="p">}</span>
<a name="cl-58"></a>
<a name="cl-59"></a>    <span class="k">static</span> <span class="k">function</span> <span class="nf">getDataByDate</span><span class="p">(</span><span class="nv">$name</span><span class="p">,</span> <span class="nv">$start_date</span><span class="p">,</span> <span class="nv">$end_date</span><span class="p">,</span> <span class="nv">$limit</span><span class="o">=</span> <span class="o">-</span><span class="m">1</span><span class="p">,</span> <span class="nv">$offset</span><span class="o">=</span> <span class="m">0</span><span class="p">)</span>
<a name="cl-60"></a>    <span class="p">{</span>
<a name="cl-61"></a>        <span class="k">throw</span> <span class="k">new</span> <span class="nx">Exception</span><span class="p">(</span><span class="s2">&quot;getDataByDate has been deprecated&quot;</span><span class="p">);</span> 
<a name="cl-62"></a>    <span class="p">}</span>
<a name="cl-63"></a>    
<a name="cl-64"></a>    <span class="k">static</span> <span class="k">function</span> <span class="nf">getDataByLocation</span><span class="p">(</span><span class="nv">$name</span><span class="p">,</span> <span class="nv">$lat</span><span class="p">,</span> <span class="nv">$lng</span><span class="p">,</span> <span class="nv">$limit</span><span class="o">=</span> <span class="o">-</span><span class="m">1</span><span class="p">,</span> <span class="nv">$offset</span><span class="o">=</span> <span class="m">0</span><span class="p">)</span>
<a name="cl-65"></a>    <span class="p">{</span>
<a name="cl-66"></a>        <span class="k">throw</span> <span class="k">new</span> <span class="nx">Exception</span><span class="p">(</span><span class="s2">&quot;getDataByLocation has been deprecated&quot;</span><span class="p">);</span> 
<a name="cl-67"></a>    <span class="p">}</span>
<a name="cl-68"></a>        
<a name="cl-69"></a>    <span class="k">static</span> <span class="k">function</span> <span class="nf">search</span><span class="p">(</span><span class="nv">$name</span><span class="p">,</span> <span class="nv">$filterdict</span><span class="p">,</span> <span class="nv">$limit</span><span class="o">=</span> <span class="o">-</span><span class="m">1</span><span class="p">,</span> <span class="nv">$offset</span><span class="o">=</span> <span class="m">0</span><span class="p">)</span>
<a name="cl-70"></a>    <span class="p">{</span>
<a name="cl-71"></a>        <span class="k">throw</span> <span class="k">new</span> <span class="nx">Exception</span><span class="p">(</span><span class="s2">&quot;apiwrapper.search has been deprecated&quot;</span><span class="p">);</span> 
<a name="cl-72"></a>    <span class="p">}</span>
<a name="cl-73"></a>    
<a name="cl-74"></a>    
<a name="cl-75"></a>    <span class="k">static</span> <span class="k">function</span> <span class="nf">Test</span><span class="p">()</span>
<a name="cl-76"></a>    <span class="p">{</span>
<a name="cl-77"></a>        <span class="nv">$name1</span> <span class="o">=</span> <span class="s2">&quot;uk-offshore-oil-wells&quot;</span><span class="p">;</span> 
<a name="cl-78"></a>        <span class="nv">$name2</span> <span class="o">=</span> <span class="s2">&quot;uk-lottery-grants&quot;</span><span class="p">;</span> 
<a name="cl-79"></a>        <span class="nb">print_r</span><span class="p">(</span><span class="nx">getKeys</span><span class="p">(</span><span class="nv">$name1</span><span class="p">));</span> 
<a name="cl-80"></a>        <span class="nb">print_r</span><span class="p">(</span><span class="nx">getData</span><span class="p">(</span><span class="nv">$name1</span><span class="p">,</span> <span class="m">110</span><span class="p">));</span> 
<a name="cl-81"></a>    <span class="p">}</span>
<a name="cl-82"></a><span class="p">}</span>
<a name="cl-83"></a>
<a name="cl-84"></a><span class="c1">//Test(); </span>
<a name="cl-85"></a><span class="cp">?&gt;</span><span class="x"></span>
</pre></div>
</td></tr></table>
  ...
  <div id="footer">
    ...
    <ul id="technologies">
      ...
      <li>r7394:a4196b9dafb6 | bitbucket02</li>
    </ul>
  </div>
